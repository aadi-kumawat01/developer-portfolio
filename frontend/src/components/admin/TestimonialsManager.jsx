...
function AvatarPanel({ form, isUploading, onUpload, onRemove }) { return <div className="sm:col-span-2"><FileUploadField label="Avatar (optional)" buttonLabel={form.avatarUrl ? "Replace Avatar" : "Choose Avatar"} accept="image/jpeg,image/png,image/webp" helpText="JPG, PNG or WebP · Max 5 MB" currentUrl={form.avatarUrl} currentFileName={form.avatarUrl ? "Current avatar" : ""} previewAlt="Avatar preview" previewClassName="h-16 w-16 rounded-full border border-white/10 object-cover" disabled={isUploading} isUploading={isUploading} onChange={onUpload} onRemove={onRemove} /></div>; }
