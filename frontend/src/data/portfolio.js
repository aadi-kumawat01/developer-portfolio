export const portfolio = {
  profile: {
    ...
    bio: null,
    location: "Jaipur",
    publicEmail: "aadityakumawat6165@gmail.com",
    profileImageUrl: "/images/profile/aditya-profile.png",
  },

  hero: {
    introduction: "DESIGN • DEVELOP • DELIVER",
    headline: "Full Stack Web Developer",
    availability: null,
    description:
      "I build fast, responsive web experiences with clean interfaces, smooth interactions and practical functionality.",
  ...
  about: {
    ...
    description:
      "I’m a full stack web developer focused on building modern web experiences with clean interfaces, responsive layouts, smooth interactions and practical functionality.",
    stats: [
      { value: "15+", label: "Practice Projects" },
  ...
  skills: {
    ...
    description:
      "My current technology stack and a self-assessment of how comfortable I am working with each tool.",
  ...
  settings: {
    title: "Aditya Kumawat — Full Stack Web Developer",
    description:
      "Portfolio of Aditya Kumawat, a Full Stack Web Developer focused on modern, responsive web experiences.",
    defaultTheme: "dark",
  },
};
